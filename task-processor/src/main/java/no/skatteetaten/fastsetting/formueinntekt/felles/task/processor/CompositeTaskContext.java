...
public class CompositeTaskContext<TRANSACTION, EXCEPTION extends Exception> extends TaskSupplement implements TaskContext<TRANSACTION, EXCEPTION> {
    ...
    @SafeVarargs
    public CompositeTaskContext(TaskContext<? super TRANSACTION, ? extends EXCEPTION>... delegates) {
    ...
    public CompletionStage<TaskContextCompletion<TRANSACTION, EXCEPTION>> apply(
        ...
        CompletionStage<TaskContextCompletion<TRANSACTION, EXCEPTION>> stage = CompletableFuture.completedStage(transaction -> decisions);
        try {
            for (TaskContext<? super TRANSACTION, ? extends EXCEPTION> delegate : delegates) {
